const renderModelosCarrito = () =>{
    ...
    for (let model of modelos_carrito) {
        salida += `<tr>
        <td><img src="${model.imagen}" alt="${model.nombre}" width="64" /></td>
...
<button class="btn btn-info w-100"  type="button" data-bs-toggle="modal" data-bs-target="#modalcontainer" onClick="finalizarCompra()";" ">Finalizar compra</button></div>`;
}
else
